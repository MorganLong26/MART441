...
function setup()
{
    ...
    // create two objects
    square1 = new Square(100,100,50,50,"grey");
    square2 = new Square(400,400,150,150,"black");
...
canvas = document.getElementById("myCanvas");
  ctx = canvas.getContext("2d");
  boxes1 = new Box(50,50,100,100,"blue");
  boxes2 = new Box(300,300,250,250,"blue");
  $.getJSON("data/points.json", function(data) {
      for(var i = 0; i < data.boxes.length; i++)
      {
         boxesArray.push(new Box(data.boxes[i].x,data.boxes[i].y, data.boxes[i].h, data.boxes[i].w, data.boxes[i].color));
      }
      drawBox();
  });
}
